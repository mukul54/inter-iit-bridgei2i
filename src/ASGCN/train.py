...
from ASGCN.models import LSTM, ASCNN, ASGCN, ASTCN
...
class Instructor:
    def __init__(self, opt):
        ...
        # self.model = self.model.load_state_dict('ASGCN/state_dict/2asgcn_interiit.pkl') 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='interiit', type=str, help='interiit')
